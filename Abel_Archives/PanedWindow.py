...
class Tela:
    def __init__(self, master):
        self.janela = master
        self.pwd_left = tk.PanedWindow(self.janela, showhandle=True, bd=10, bg="red")
        self.lbl_left = tk.Label(self.pwd_left, text="left")
        self.pwd_right = tk.PanedWindow(self.janela, orient=tk.VERTICAL, bd=5, bg="green")

        self.lbl_right = tk.Label(self.pwd_right, text="right")
        self.lbl_right2 = tk.Label(self.pwd_right, text="right2")
