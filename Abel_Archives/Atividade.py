...
class Tela:
    ...
    def salvar_cadastro(self):
        ...
        self.funcionarios.append((nome, data_nasc, documento))
    ...
    def visualizar_cadastro(self):
        ...
        colunas = ("Nome", "Data de Nascimento", "Documento")
    ...
    def __init__(self, master):
        ...
        label_inicio = tk.Label(self.janela, text="Boas vindas ao sistema de cadastramento!", font=("Arial", 16),
                                bg="#92D975")
